...
Cada **#** es una unidad de trazabilidad (bloque migrable). Las columnas **Ruta(s) legado** y **Paths legado** SHALL completarse tras clon e inventario.
...
Orden para inventario y para agentes **Foreach** sobre paths del **legado**: misma numeración que el catálogo (**shell** primero, luego **feature**). Sustituir `TBD` tras Ola 1.
