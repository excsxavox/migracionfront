...
| *TBD: env / proxy / estilos globales legado* | `environment*.ts`, `proxy.conf.json`, `src/styles.css`, `src/index.html`, mock interceptor | **#4** | **Destino implementado**; paridad tokens vs legado pendiente inventario |
