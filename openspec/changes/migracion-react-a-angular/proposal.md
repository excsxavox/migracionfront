...
| *TBD: rutas/pantallas SPA fuera del listado **#2*** | *TBD* `src/app/features/<dominio>/…` (lazy + `pages/` por pantalla; ver `tasks.md` **3.1**, catálogo **#5**) | **#5** (`feature`) | **No iniciado** — plantilla Foreach y subchecklist **3.1a–f** documentadas (2026-04-23); implementación tras inventario **Ola 1** |
